...
(11, 'BOI'),(12, 'BI'),(13, 'BOI_Anw'),(14, 'HBMz'),(15, 'HBM*'),(16, 'HBM'),(17, 'OBM'),(18, 'BM'),(19, 'BM_Anw');
...
CREATE TABLE [dbo].[Dienststellen](Dienststellen_ID int PRIMARY KEY,
                    ...
                    CONSTRAINT Direktions_Fk FOREIGN KEY (Direktions_ID) REFERENCES Direktion(Direktions_ID)); 
...
(51, 'RTW', 'RTW-S(BTW)'),(52, 'RTW', 'RTW-I(Intensiv)'),(53, 'RTW', 'RTW_ASB'),(54, 'RTW', 'RTW_DRK'),(55, 'RTW', 'RTW_JUH'),(56, 'RTW', 'RTW_MHD'),(57, 'RTW', 'RTW_BW'),(58, 'NEF', 'NEF'),
(59, 'Fmel', 'Fernmelder'); 
...
CREATE TABLE [dbo].[Fahrzeugfunktionen](Fahrzeugfunktionen_ID int PRIMARY KEY,
                    ...
                    Grund_Qualifizierung int,

                    CONSTRAINT Fahrzeuge_Fk FOREIGN KEY (Fahrzeuge_ID) REFERENCES Fahrzeuge(Fahrzeuge_ID));
...
(48, 8, '841', 'Klef', 'NULL'),(49, 8, '842', 'Klef', 'NULL'),

(50, 0, '841', 'LKW', 'NULL'), -- Gruppieren aller LKW ?
(51, 9, '111', 'ELW-A', 'NULL'),(52, 9, '112', 'ELW-A', 'NULL'),
(53, 10, '141', 'ELW-B', 'NULL'),(54, 10, '142', 'ELW-B', 'NULL'),
(55, 11, '311', 'ELW-C', 'NULL'),(56, 11, '312', 'ELW-C', 'NULL'),
(57, 12, '321', 'ELW-C ÄLRD', 'NULL'),(58, 12, '322', 'ELW-C ÄLRD', 'NULL'),
(59, 13, 'ELW-3', 'ELW-3', 'NULL'),(60, 13, 'ELW-3', 'ELW-3', 'NULL'),
(61, 14, 'FmeW', 'FmeW', 'NULL'),(62, 19, '571', 'RTB', 'NULL'),(63, 19, '572', 'RTB', 'NULL'),(64, 59, '881', 'FernMel', 'NULL');
...
CREATE TABLE [dbo].[Fahrzeugzuordnung_Dienststelle](Dienststellenzuordnung_ID int PRIMARY KEY,
                    ...
                    CONSTRAINT Fahrzeuge_Fk FOREIGN KEY (Fahrzeuge_ID) REFERENCES Fahrzeuge(Fahrzeuge_ID),
                    CONSTRAINT Dienststellen_Fk FOREIGN KEY (Dienststellen_ID) REFERENCES Dienststellen(Dienststellen_ID)) ;
...
CREATE TABLE [dbo].[Fahrzeugzuordnung_Stützpunkt](Stuetzpunktzuordnung_ID int PRIMARY KEY,
                    ...
                    CONSTRAINT Stuetzpunkt_Fk FOREIGN KEY (Stuetzpunkt_ID) REFERENCES Stuetzpunkt(Stuetzpunkt_ID),
                    CONSTRAINT Fahrzeuge_Fk FOREIGN KEY (Fahrzeuge_ID) REFERENCES Fahrzeuge(Fahrzeuge_ID));
...
CREATE TABLE [dbo].[Funktionsbesetzung](Besetzungs_ID int PRIMARY KEY,
                                        ...
                                        CONSTRAINT Personal_Fk FOREIGN KEY (Personal_ID) REFERENCES Personal(Personal_ID),
                                        CONSTRAINT Wachabteilungs_Fk FOREIGN KEY (Wachabteilungs_ID) REFERENCES Wachabteilung(Wachabteilungs_ID)) ;

-----------------------------------------------------------------------------------------------------------------------
-- Tabellenstruktur für Tabelle "Personaldaten"
CREATE TABLE [dbo].[Personaldaten](Personal_ID int PRIMARY KEY, Adresse varchar(50), Ort varchar(30), PLZ varchar(6),
                    HNr varchar(10), Zusatz varchar(20), Telefon varchar(25), Handy varchar(25), Geburtsdatum Date);

SET IDENTITY_INSERT [dbo].[Personaldaten] ON;

--INSERT INTO [dbo].[Personaldaten](Personal_ID int, Adresse, Ort, PLZ, HNr, Zusatz, Telefon, Handy, Geburtsdatum) VALUES
...
CREATE TABLE [dbo].[Stützpunkte_has_Dienststellen](Dienststelle_has_ID int PRIMARY KEY,
                                                    ...
                                                    CONSTRAINT StuePun_Fk FOREIGN KEY (Stuetzpunkt_ID) REFERENCES Dienstgrad(Dienstgrad_ID),
                                                    CONSTRAINT StuePunRang_Fk FOREIGN KEY (Stuetzpunkt_ID) REFERENCES Dienstgrad(Dienstgrad_ID));
...
CREATE TABLE [dbo].[Personal](Personal_ID int PRIMARY KEY,
            ...
            FwZuordnung_ID int
            CONSTRAINT DG_Fk FOREIGN KEY (Dienstgrad_ID) REFERENCES Dienstgrad(Dienstgrad_ID),
            CONSTRAINT Dienststellen_Fk FOREIGN KEY (Dienststellen_ID)  REFERENCES Dienststellen(Dienststellen_ID),
            CONSTRAINT Wachabteilung_Fk FOREIGN KEY (Wachabteilung_ID)  REFERENCES Wachabteilung(Wachabteilung_ID),
            CONSTRAINT FwZuordnung_Fk FOREIGN KEY (FwZuordnung_ID)  REFERENCES FwZuordnung(FwZuordnung_ID));
